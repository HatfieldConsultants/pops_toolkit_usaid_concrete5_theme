...
(function($) {
  ...
  function _slideIn($panel) {
    ...
    if ($('main').hasClass(options.bodyClass) || sliding) {
      return;
    }
    ...
    $('main').addClass(options.bodyClass).one(TRANSITION_END, function(e) {
      sliding = false;
  ...
  $.panelslider.close = function(callback) {
    ...
    $('main').removeClass(options.bodyClass).one(TRANSITION_END, function(e) {
      sliding = false;
